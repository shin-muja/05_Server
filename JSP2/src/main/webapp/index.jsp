...
<body>
	...
	<form action="/el/test1">
		...
		<div>
			<lable>A <input type="checkbox" name="check" value="A"></lable>
			<lable>B <input type="checkbox" name="check" value="B"></lable>
			<lable>C <input type="checkbox" name="check" value="C"></lable>
		</div>
