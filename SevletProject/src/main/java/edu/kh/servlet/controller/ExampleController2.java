...
// Servlet 관련 코드를 작성하기 위해서는 HttpServlet클래스 상속 받아야한다
// -> 상속 받았다고 해서 바로 Servlet 등록이 되는것은 아님
 ...
 * <servlet> <servlet-mapping>을 작석하는 효과
 * 
 */
...
public class ExampleController2 extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// 해별방법 : 전달받은 데이터의 문자 인코딩을서버에 맞게 변경
		// req.setCharacterEncoding("UTF-8");
		// -> tomcat 10 버전 이상부터 자동으로 인코딩 처리를 해주기 때문에
		// 개발자가 직접 추가적인 처리 할 필요X
		...
		// -> 그렇기에 JSP가 대신 화면을 만들어 달라며 위임
		// -> Servlet이 JSP에게 요청을 위임
		
		// JSP가 대신응답화면을 만들어 주기 위해서는
